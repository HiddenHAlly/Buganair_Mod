...
public final class BuganairServerGliderState {
    ...
    private static final Map<UUID, Float> ROLL = new HashMap<>();
    ...
    public static float getRoll(UUID uuid)  { return ROLL.getOrDefault(uuid, 0f); }

    public static void updateOrientation(UUID uuid, float pitch, float yaw, float roll) {
